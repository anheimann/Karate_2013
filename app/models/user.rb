class User < ActiveRecord::Base  
  ...
  # code above is commented out because it won't work with nested form for user, i.e, can't validate a user that is being created simultaneously as the student
